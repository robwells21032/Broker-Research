...
![](images - storage/UARK logo NEW.jpg)  

<br>   


![](images - storage/Reynolds logo2.jpg)   
...
Reporter for Dow Jones, Bloomberg: DC
The Associated Press: DC, NY, KY, CA, NV
...
![Wall Street Wrongdoers](images - storage/Wall Street Wrongdoers.png)
---
...
![Credit- Mike Licht, NotionsCapital.com](images - storage/smoking gun.jpg)  
...
###FINRA BrokerCheck 
![ ](images - storage/BrokerCheck.jpeg) 
---
> [BrokerCheck: "CNTL" + click for a New Tab](http://www.finra.org/Investors/ToolsCalculators/BrokerCheck){target="_blank"}
...
![ ](images - storage/Investment Advisers.jpeg) 
---
> [IAPD Database: "CNTL" + click for a New Tab](http://www.adviserinfo.sec.gov/IAPD/Content/Search/iapd_Search.aspx){target="_blank"}
...
![ ](images - storage/NASAA.jpeg)
---
> [NASAA Database: "CNTL" + click for a New Tab](http://www.nasaa.org/regulatory-activity/enforcement-legal-activity/enforcement-directory/){target="_blank"}
...
![ ](images - storage/CFP.jpeg)
---
> [CFP Records: "CNTL" + click for a New Tab](http://www.cfp.net/about-cfp-board/ethics-enforcement/disciplined-individuals-by-state){target="_blank"}
...
###How to Search It
> Having a CRD number speeds your search. CRDs are available on complaints, aribtration records 
> Searching by Zip Code can help survey activity in your community
> For example, a search of my Fayetteville, Ark. zip code - 72701 - brings up 411 brokers in town and surrounding cities.
...
![ ](images - storage/Madoff Headline.png) 
Credit: Flickr user Petezin

![ ](images - storage/Madoff Employment.jpeg) 

![ ](images - storage/Madoff case detail.jpeg)
---
...
> [Search BrokerCheck: "CNTL" + click for a New Tab](http://www.finra.org/Investors/ToolsCalculators/BrokerCheck/){target="_blank"}
...
![ ](images - storage/Find Current Employees.jpeg)
...
![ ](images - storage/Donor-Stephens.jpeg)

> [Search OpenSecrets database: "CNTL" + click for a New Tab](https://www.opensecrets.org/donor-lookup/advanced){target="_blank"}



> This search is for contributors to Sen. Tom Cotton's campaign who put Stephens Inc. as their employer. 
> Let's switch back to BrokerCheck and look up Warren A. Stephens, a frequent contributor.  

![ ](images - storage/Stephens employment.jpeg)  
...
![ ](images - storage/Barred Brokers.jpeg)
...
![ ](images - storage/Barred Brokers2.jpeg)

> [List of Barred Brokers: "CNTL" + click for a New Tab](https://www.finra.org/industry/individuals-barred-finra-a){target="_blank"}
...
![ ](images - storage/Monthly Disciplinary Actions.jpeg)

***
<br>

> [Monthly Actions: "CNTL" + click for a New Tab](https://www.finra.org/industry/disciplinary-actions){target="_blank"}
...
![ ](images - storage/Meier - FINRA release.jpeg)
...
> [Detail from Meier case: "CNTL" + click for a New Tab](https://brokercheck.finra.org/individual/summary/1146044){target="_blank"}

<br>

####Press Coverage of Case

![ ](images - storage/Meier Press coverage.jpeg)
...
![ ](images - storage/Deborah Dickson Kelley.png)
...
![ ](images - storage/Kelley article.png)
...
![ ](images - storage/Corzine summary slide.jpeg)  
...
![ ](images - storage/Corzine Record.png)

####Check complaints:  

![ ](images - storage/Corzine Disclosure.png)


***  
***   

![ ](images - storage/Wash Post - Bales .jpeg)
...
![ ](images - storage/Bales work history.png)


####Examine Complaints

![ ](images - storage/Bales dispute.png)
...
![ ](images - storage/Bales arbitration.png)
...
> [Search Office of Hearing Officers: "CNTL" + click for a New Tab](http://www.finra.org/industry/oho){target="_blank"}
...
![ ](images - storage/Check Locals.png)
> [Search BrokerCheck: "CNTL" + click for a New Tab](http://www.finra.org/Investors/ToolsCalculators/BrokerCheck/){target="_blank"}
...
***  
***  
![ ](images - storage/Not Perfect.jpeg)
...
> [PIABA Critique of BrokerCheck: "CNTL" + click for a New Tab](https://piaba.org/in-the-media/piaba-warning-finra-withholds-critical-red-flag-information-broker-background-check){target="_blank"}
...
![ ](images - storage/Reuters Finra.png)  


An excellent 2017 Reuters investigation that scraped the FINRA data and analyzed it.  

> [Reuters Series on BrokerCheck: "CNTL" + click for a New Tab](https://www.reuters.com/article/us-usa-finra-brokers-specialreport/special-report-regulator-blocks-public-scrutiny-of-firms-with-tainted-brokers-idUSKBN19327T){target="_blank"}> 
...
![ ](images - storage/wsj expunge.png)

> [WSJ - Red Flags Not Disclosed: "CNTL" + click for a New Tab](https://www.wsj.com/articles/no-headline-available-1394061989){target="_blank"}
...
![ ](images - storage/NYT expunge.png)

> [CFP Records: "CNTL" + click for a New Tab](https://dealbook.nytimes.com/2013/06/10/a-rise-in-requests-from-brokers-to-wipe-the-slate-clean/){target="_blank"}
...
> [Full-Text of Arbitration Filings: "CNTL" + click for a New Tab](http://www.finra.org/arbitration-and-mediation/arbitration-awards){target="_blank"}
--Material linked in BrokerCheck but worth searching.


> [Finra Disciplinary Actions Database (FDA): "CNTL" + click for a New Tab](http://disciplinaryactions.finra.org/){target="_blank"}
...
> [Search Investment Adviser database: "CNTL" + click for a New Tab](http://www.adviserinfo.sec.gov/IAPD/Content/Search/iapd_Search.aspx){target="_blank"}
...
***
***
![ ](images - storage/Investment Advisers rules.jpeg)
...
![ ](images - storage/rapert.jpeg)

<br>  


Arkansas State Senator Jason Rapert, chairman of the Insurance Committee, is active nationally on these issues. 
What is his story?   
...
![ ](images - storage/Rapert IAPD search.jpeg)

![ ](images - storage/Rapert IAPD2.jpeg)
...
![ ](images - storage/Rapert insurance.jpeg)
...
![ ](images - storage/Clayton Cohn IA.jpeg)
...
> [SEC Action Look-Up: "CNTL" + click for a New Tab](https://www.sec.gov/litigations/sec-action-look-up){target="_blank"}
...
![This chart shows the significant amount of enforcement activity at the state level. ](images - storage/nasaa stats.jpeg)

> [NASAA Directory: "CNTL" + click for a New Tab](http://www.nasaa.org/regulatory-activity/enforcement-legal-activity/enforcement-directory/){target="_blank"}
...
![ ](images - storage/CFP Discipline.png)
...
> [CFP Records by State: "CNTL" + click for a New Tab](http://www.cfp.net/about-cfp-board/ethics-enforcement/disciplined-individuals-by-state){target="_blank"}


####Select one of those individuals with a revoked designation
> [CFP Records By Name: "CNTL" + click for a New Tab](http://www.letsmakeaplan.org/choose-a-cfp-professional/find-a-cfp-professional?#oname){target="_blank"}


![ ](images - storage/Greeves.png)
---

####Example of Disciplinary Record
![ ](images - storage/Greeves detail.png)
...
> [Financial Designations: "CNTL" + click for a New Tab](http://www.finra.org/investors/accredited-designations){target="_blank"}
